...
SOURCES += \
  $$SRC_DIR/libsrc/cielabutil.cc \
  $$SRC_DIR/libsrc/iodcommn.cc \
  $$SRC_DIR/libsrc/iodcontentitemmacro.cc \
  $$SRC_DIR/libsrc/iodmacro.cc \
  $$SRC_DIR/libsrc/iodreferences.cc \
  $$SRC_DIR/libsrc/iodrules.cc \
  $$SRC_DIR/libsrc/iodtypes.cc \
  $$SRC_DIR/libsrc/iodutil.cc \
  $$SRC_DIR/libsrc/modacquisitioncontext.cc \
  $$SRC_DIR/libsrc/modbase.cc \
  $$SRC_DIR/libsrc/modcommoninstanceref.cc \
  $$SRC_DIR/libsrc/modenhequipment.cc \
  $$SRC_DIR/libsrc/modenhusimage.cc \
  $$SRC_DIR/libsrc/modenhusseries.cc \
  $$SRC_DIR/libsrc/modequipment.cc \
  $$SRC_DIR/libsrc/modfloatingpointimagepixel.cc \
  $$SRC_DIR/libsrc/modfor.cc \
  $$SRC_DIR/libsrc/modgeneralimage.cc \
  $$SRC_DIR/libsrc/modgeneralseries.cc \
  $$SRC_DIR/libsrc/modgeneralstudy.cc \
  $$SRC_DIR/libsrc/modhelp.cc \
  $$SRC_DIR/libsrc/modimagepixel.cc \
  $$SRC_DIR/libsrc/modimagepixelbase.cc \
  $$SRC_DIR/libsrc/modmultiframedimension.cc \
  $$SRC_DIR/libsrc/modmultiframefg.cc \
  $$SRC_DIR/libsrc/modpatient.cc \
  $$SRC_DIR/libsrc/modpatientstudy.cc \
  $$SRC_DIR/libsrc/modsegmentationseries.cc \
  $$SRC_DIR/libsrc/modsopcommon.cc \
  $$SRC_DIR/libsrc/modsynchronization.cc \
  $$SRC_DIR/libsrc/modusfor.cc \
