...
MRichTextEdit::MRichTextEdit(QWidget *parent) : QWidget(parent) {
 ...
 connect(f_inlquote, SIGNAL(clicked()), this, SLOT(text_inl_quote()));
 connect(f_blkquote, SIGNAL(clicked()), this, SLOT(text_blk_quote()));
...
QString MRichTextEdit::text_as_gtagml()
{
...
void MRichTextEdit::textSource() {
 ...
 pte->setPlainText( f_textedit->toMarkdown() );
...
{
 if(current_edit_mode_ == Edit_Modes::GTagML)
 {
...
void MRichTextEdit::text_blk_quote()
{

}

void MRichTextEdit::text_inl_quote()
{
