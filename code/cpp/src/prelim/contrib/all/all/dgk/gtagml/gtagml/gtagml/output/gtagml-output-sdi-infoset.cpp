...
void GTagML_Output_SDI_Infoset::finalize_widowed_sentence_boundaries(GH_Block_Base& bl)
{
 ...
 {
  QMultiMapIterator<caon_ptr<tNode>, u4> it(widowed_sentence_starts_);
  while(it.hasNext())
  {
   it.next();
   u4 i = it.value();
 ...
 {
  QMultiMapIterator<caon_ptr<tNode>, u4> it(declared_sentence_starts_);
  while(it.hasNext())
  {
   it.next();
   u4 i = it.value();
 ...
 {
  QMultiMapIterator<caon_ptr<tNode>, u4> it(widowed_sentence_ends_);
  while(it.hasNext())
  {
   it.next();
   u4 i = it.value();
 ...
 {
  QMultiMapIterator<caon_ptr<tNode>, u4> it(declared_sentence_ends_);
  while(it.hasNext())
  {
   it.next();
   u4 i = it.value();
