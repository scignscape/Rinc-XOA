...
//#include "_eval-Xof1.h"
USING_OTNS(Chasm_TR)

#define FULL_INCLUDE
#include "../dev/consoles/fns/run/run-aXof1/run-s01-Xof1-re0.cpp"
#include "../dev/consoles/fns/run/run-aXof1/run-s01-Xof1-re1.cpp"
#include "../dev/consoles/fns/run/run-aXof1/run-s01-Xof1-re2.cpp"
#include "../dev/consoles/fns/run/run-aXof1/run-s01-Xof1-re3.cpp"
#include "../dev/consoles/fns/run/run-aXof1/run-s01-Xof1-re4.cpp"
#include "../dev/consoles/fns/run/run-aXof1/run-s01-Xof1-re5.cpp"
#include "../dev/consoles/fns/run/run-aXof1/run-s01-Xof1-re6.cpp"
#include "../dev/consoles/fns/run/run-aXof1/run-s01-Xof1-re7.cpp"
#include "../dev/consoles/fns/run/run-aXof1/run-s01-Xof1-re8.cpp"
#include "../dev/consoles/fns/run/run-aXof1/run-s01-Xof1-re9.cpp"
...
{
 #include "../dev/consoles/fns/eval/aXof1/ch-eval-s01_Xof1_re9.cpp"
}
