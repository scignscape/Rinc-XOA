...
//?        ui->language->setCurrentLanguage(QLocale().language());
        //?ui->cb_language_->setCurrentLanguage("English");
...
//?        m_Model = patient();
    ...
    QWidget *getWidget(IdentityEditorWidget::AvailableWidget widget)
    {
        ...
        case IdentityEditorWidget::Language_QLocale: return ui->cb_language_; //?ui->language;
        case IdentityEditorWidget::LanguageIso: return ui->cb_language_; //?ui->language;
