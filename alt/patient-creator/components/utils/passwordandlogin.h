...
UTILS_EXPORT QByteArray nonDestructiveEncryption(const QString &text, const QString &key = QString_null);
UTILS_EXPORT QString decrypt(const QByteArray &text, const QString &key = QString_null);
