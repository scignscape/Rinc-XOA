...
public:
    ...
    static void addError( const QObject * o, const QString & err, const QString &file = QString_null, const int line = -1, bool forceWarning = false );
    static void addError( const QString & object, const QString & err, const QString &file = QString_null, const int line = -1, bool forceWarning = false );

    static void addErrors( const QObject * o, const QStringList & err, const QString &file = QString_null, const int line = -1, bool forceWarning = false );
    static void addErrors( const QString &o, const QStringList & err, const QString &file = QString_null, const int line = -1, bool forceWarning = false );

//?    static void addQueryError( const QObject * o, const QSqlQuery & q, const QString &file = QString_null, const int line = -1, bool forceWarning = false );
//    static void addQueryError( const QString & o, const QSqlQuery & q, const QString &file = QString_null, const int line = -1, bool forceWarning = false );

//?    static void addDatabaseLog( const QObject * o, const QSqlDatabase & q, const QString &file = QString_null, const int line = -1, bool forceWarning = false );
//    static void addDatabaseLog( const QString & o, const QSqlDatabase & q, const QString &file = QString_null, const int line = -1, bool forceWarning = false );
    ...
    static QString     toString( const QString & settingsLog = QString_null );
    static QString     saveLog( const QString & fileName = QString_null );
