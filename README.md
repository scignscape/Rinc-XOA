...
In publishing, Diamond $\color{black}{\textbf{(}}\color{#a65450}{\mathrm{\large{}DiamondOA}}\color{black}{\textbf{)}}$ is the most complete Open Access model, with no fees either for authors (i.e., Article Processing Charges 
