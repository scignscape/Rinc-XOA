...
$\color{#a65450}\mathrm{Qynviper}$ here is to generate $\color{#a65450}\text{C}\large{}\text{++}$ code: $\color{#a65450}\mathrm{AMPATH}$ configuration files are first parsed into VM scripts which are separately executed to create the final $\color{#a65450}\mathrm{GUI}$ code.
